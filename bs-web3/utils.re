...
[@bs.scope "utils"] [@bs.module "web3"] external toWei : int => string => Types.big_number = "";
[@bs.scope "utils"] [@bs.module "web3"] external toWeiBN : Types.big_number => string => Types.big_number = "toWei";
