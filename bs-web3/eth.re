...
type balance = Types.big_number;
[@bs.send] external getBalance : t => address => Js.Promise.t(balance) = "";
...
[@bs.send.pipe : t] [@bs.scope "personal"] external sign : string => address => Js.Promise.t(string) = "";
